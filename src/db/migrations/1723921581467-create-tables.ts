...
export class CreateTables1723921581467 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order_itens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "sell_price" integer NOT NULL, "orderId" uuid, "productId" uuid, CONSTRAINT "PK_4e69f9594b97fc9d37c2e398688" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
